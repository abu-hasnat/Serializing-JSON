    ...
    public partial class CreateTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Route",
                columns: new[] { "Number", "BicycleAccessible", "Direction", "Name", "RampAccessible" },
                values: new object[,]
                {
                    { 1, true, 0, "North", true },
                    { 2, true, 3, "West", false }
            ...
            migrationBuilder.InsertData(
                table: "Stop",
                columns: new[] { "Number", "Direction", "Name", "Street" },
                values: new object[,]
                {
                    { 1, 0, "North", "North" },
                    { 2, 3, "North", "West" }
            ...
            migrationBuilder.InsertData(
                table: "ScheduledStop",
                columns: new[] { "Id", "StopNumber", "RouteNumber", "ScheduledArrival" },
                values: new object[,]
                {
                    { 1, 1, 1, DateTime.Now.AddHours(1) },
                    { 2, 1, 1, DateTime.Now.AddHours(2) },
                    { 3, 1, 1, DateTime.Now.AddHours(3) },
                    { 4, 1, 2, DateTime.Now.AddHours(4) },
                    { 5, 1, 2, DateTime.Now.AddHours(5) },
                    { 6, 2, 2, DateTime.Now.AddHours(1) },
                    { 7, 2, 2, DateTime.Now.AddHours(2) },
                    { 8, 2, 2, DateTime.Now.AddHours(3) },
                    { 9, 2, 1, DateTime.Now.AddHours(4) },
                    { 10, 2, 1, DateTime.Now.AddHours(5) }
                });
